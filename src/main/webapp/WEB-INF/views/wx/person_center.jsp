...
<!--主体-->
		...
		<div class="weui-cell">
			   <div class="weui-cell__bd" style="text-align:center;">
			     <p>
			     	...
			     	<div style="float:left;margin-left:-39%;font-size: large;">个人中心</div>
			     </p>
			   </div>
			 </div>
	...
	<div class="weui-cells" style="height: 65%;">
		<div class="weui-cell">
			<div class="weui-cell__bd"><img style="width: 30px;height: 30px;" src="https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=611116088,4106962857&fm=27&gp=0.jpg"></div>
