		...
		<div class="weui-cells">
			 <div class="weui-cell">
			   <div class="weui-cell__bd" style="text-align:center;">
			     <p>
			  		<div style="margin-left:-66%;float:left;"><img src="${pageContext.request.contextPath}/static/images/wx/back.png" style="width:6%;height:6%;"></img></div>   
			     	<div style="float:left;margin-left:-39%;">本周菜单</div>
			     </p>
			   </div>
			 </div>
			 <div class="weui-cell">
		...
		<div class="weui-cells">
			<div class="weui-cell">
				<div class="weui-cell__bd" style="text-align:center;margin-left: 15%;">
					<div class="packStyle">减脂</div>
					<div class="packStyle packActive">塑形</div>
					<div class="packStyle">增脂</div>
				</div>
			</div>
