...
<header class="wy-header">
  ...
  <div class="wy-header-title">增加收货地址</div>
</header>
<div class="weui-content">
  <div class="weui-cells weui-cells_form wy-address-edit">
    <div class="weui-cell">
      <div class="weui-cell__hd"><label class="weui-label wy-lab">收货人</label></div>
      <div class="weui-cell__bd"><input class="weui-input" type="text" placeholder="" id="person" ></div>
    </div>
    <div class="weui-cell">
      <div class="weui-cell__hd"><label class="weui-label wy-lab">收货电话</label></div>
      <div class="weui-cell__bd"><input class="weui-input" type="number" pattern="[0-9]*" placeholder="" id="phone"></div>
    </div>
    <div class="weui-cell">
      <div class="weui-cell__hd"><label for="name" class="weui-label wy-lab">所在地区</label></div>
      <div class="weui-cell__bd"><input class="weui-input" id="address" type="text" readonly="true"></div>
    </div>
    <div class="weui-cell">
      <div class="weui-cell__hd"><label class="weui-label wy-lab">详细地址</label></div>
      <div class="weui-cell__bd">
        <textarea class="weui-textarea" placeholder="" id="address_detail"></textarea>
      </div>
    </div>
  </div> 
       	...
       	$.ajax({
            ...
            success:function(data){
            	if(data){
            		...
            		window.location.href = "${pageContext.request.contextPath}/dcxt/accountaddress/addressListByWeiXin?accountId=${accountId}";
            	}
            },
            error: function(){
                //请求出错处理
