...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/sys/office/"><spring:message code='organization.list'/></a></li>
    <li class="active"><a
...
<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
    ...
    <div class="control-group">
        <label class="control-label"><spring:message code='parent.organization'/>:</label>
        <div class="controls">
    ...
    <div class="control-group">
        <label class="control-label"><spring:message code='organization.district'/>:</label>
        <div class="controls">
            <tags:treeselect id="area" name="area.id" value="${office.area.id}" labelName="area.name"
                             labelValue="${office.area.name}"
                             title="区域" url="/sys/area/treeData" cssClass="required" serviceLevel="0"/>
        </div>
    </div>
    <div class="control-group">
        <label class="control-label"><spring:message code='organization.name'/>:</label>
        <div class="controls">
            <form:input path="name" htmlEscape="false" maxlength="50" class="required"/>
        </div>
    </div>
    <div class="control-group">
        <label class="control-label"><spring:message code='organization.number'/>:</label>
        <div class="controls">
            <form:input path="code" htmlEscape="false" maxlength="50"/>
        </div>
    </div>
    <div class="control-group">
        <label class="control-label"><spring:message code='organization.type'/>:</label>
        <div class="controls">
    ...
    <div class="control-group">
        <label class="control-label"><spring:message code='organization.level'/>:</label>
        <div class="controls">
    ...
    <div class="control-group">
        <label class="control-label"><spring:message code='adress'/>:</label>
        <div class="controls">
            <form:input path="address" htmlEscape="false" maxlength="50"/>
        </div>
    </div>
    <div class="control-group">
        <label class="control-label"><spring:message code='postcode'/>:</label>
        <div class="controls">
            <form:input path="zipCode" htmlEscape="false" maxlength="50"/>
        </div>
    </div>
    <div class="control-group">
        <label class="control-label"><spring:message code='officer'/>:</label>
        <div class="controls">
    ...
    <div class="control-group">
        <label class="control-label"><spring:message code='fax'/>:</label>
        <div class="controls">
    ...
    <div class="form-actions">
        <shiro:hasPermission name="sys:office:edit"><input id="btnSubmit" class="btn btn-primary" type="submit"
                                                           value="<spring:message code='save' />"/>&nbsp;</shiro:hasPermission>
