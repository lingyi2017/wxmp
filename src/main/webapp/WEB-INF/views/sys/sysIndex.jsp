	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
	      <div class="navbar-inner">
	      	 <div class="brand"><spring:message code='production.name' /></div>
	         <div class="nav-collapse">
	           ...
	           <ul class="nav pull-right">
				 <li id="themeSwitch" class="dropdown">
			  	 ...
			  	 <li class="dropdown">
				    <a class="dropdown-toggle" data-toggle="dropdown" href="#" title="个人信息">您好, <shiro:principal property="loginName"/></a>
				    <ul class="dropdown-menu">
