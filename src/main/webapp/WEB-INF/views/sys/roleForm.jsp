...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="${ctx}/sys/role/form?id=${role.id}"><spring:message code='role'/><shiro:hasPermission
            name="sys:role:edit">${not empty role.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission
            name="sys:role:edit"><spring:message code='check'/></shiro:lacksPermission></a></li>
</ul>
<br/>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <tags:treeselect id="office" name="office.id" value="${role.office.id}" labelName="office.name"
                             ...
                             title="机构" url="/sys/office/treeData" cssClass="required" serviceLevel="0"/>
        </div>
    </div>
    <div class="control-group">
