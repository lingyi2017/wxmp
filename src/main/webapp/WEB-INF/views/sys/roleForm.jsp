...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/sys/role/form?id=${role.id}"><spring:message code='role' /><shiro:hasPermission name="sys:role:edit">${not empty role.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:role:edit"><spring:message code='check' /></shiro:lacksPermission></a></li>
	</ul><br/>
