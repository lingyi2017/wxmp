...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="${ctx}/qyfw/customer/form?id=${customer.id}">客户<shiro:hasPermission
            name="qyfw:customer:edit">${not empty customer.id?'修改':'添加'}</shiro:hasPermission></a></li>
</ul>
<br/>
