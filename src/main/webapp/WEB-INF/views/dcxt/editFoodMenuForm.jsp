...
<head>
    ...
    <script type="text/javascript" charset="utf-8"
            src="${ctx}/static/js/dcxt/editFoodMenu.js?d=<%=new java.util.Date() %>"></script>
...
<ul class="nav nav-tabs">
    ...
    <shiro:hasPermission name="dcxt:foodMenu:edit">
        <li class="active"><a>菜单修改</a></li>
    </shiro:hasPermission>
</ul>

<form:form id="inputForm" method="post" class="form-horizontal">
    <input type="hidden" name="" id="foodMenuId" value="${foodMenu.id}"/>
    <!-- 菜单布局 Start -->
    ...
    <div class="form-actions">
        <shiro:hasPermission name="dcxt:foodMenu:edit">
            <input id="btnSubmit" class="btn btn-primary" type="button" onclick="editFoodMenu()"
