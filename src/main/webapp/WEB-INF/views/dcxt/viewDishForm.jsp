...
<form:form id="inputForm" modelAttribute="dish" action="${ctx}/dcxt/dish/save" method="post" class="form-horizontal">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <label class="lbl">${fns:getDictLabel(dish.type, 'dcxt_dish_type', '无')}</label>
        </div>
    </div>
    <div class="control-group">
        <label class="control-label">状态:</label>
        <div class="controls">
            <label class="lbl">${fns:getDictLabel(dish.state, 'dcxt_state', '无')}</label>
        </div>
    </div>
    <div class="control-group">
        <label class="control-label">图片:</label>
        <div class="controls">
            <input id="image" name="image" type='hidden' value="${dish.image}"/>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:input path="introduce" htmlEscape="false" rows="3" maxlength="200" class="input-xlarge"
                        readonly="true"
                        type="hidden"/><label class="lbl">${dish.introduce}</label>
        </div>
    </div>
    <div class="control-group">
        <label class="control-label">备注:</label>
        <div class="controls">
            <form:input path="remarks" htmlEscape="false" rows="3" maxlength="200" class="input-xlarge" readonly="true"
                        type="hidden"/><label class="lbl">${dish.remarks}</label>
        </div>
    </div>
