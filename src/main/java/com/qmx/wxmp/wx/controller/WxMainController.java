...
public class WxMainController extends GenericController {
    ...
    @Autowired
    protected WxMainService mainService;
    ...
    public void wechatCore(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if ("raw".equals(encryptType)) {
            ...
            WxMpXmlOutMessage outMessage = this.mainService.route(inMessage);
