...
import com.qmx.wxmp.common.utils.FileUtils;
import com.qmx.wxmp.common.utils.FreeMarkers;
...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		String packageName = "com.qmx.wxmp";
		
		String moduleName = "jzgs";			// 模块名，例：sys
		String subModuleName = "";				// 子模块名（可选） 
		String className = "product";			// 类名，例：user
		String classAuthor = "Free Lancer";		// 类作者，例：Free Lancer
		...
		// 模板文件路径
		String tplPath = StringUtils.replace(projectPath+"/src/main/java/com/qmx/wxmp/generate/template", "/", separator);
