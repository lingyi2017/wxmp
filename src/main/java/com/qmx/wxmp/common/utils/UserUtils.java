...
import com.qmx.wxmp.entity.sys.*;
import com.qmx.wxmp.repository.hibernate.qyfw.ServiceCategoryDao;
import com.qmx.wxmp.repository.hibernate.sys.*;
...
public class UserUtils extends BaseService {
	...
	private static ServiceCategoryDao	serviceCategoryDao			= ApplicationContextHelper
			.getBean(ServiceCategoryDao.class);
	...
	public static final String			CACHE_SERVICE_CATEGORY_LIST	= "serviceCategoryList";
	...
	public static List<ServiceCategory> getServiceCategoryList() {
		@SuppressWarnings("unchecked")
		List<ServiceCategory> serviceCategoryList = (List<ServiceCategory>) getCache(CACHE_SERVICE_CATEGORY_LIST);
		if (serviceCategoryList == null) {
			serviceCategoryList = serviceCategoryDao.findAllList();
			putCache(CACHE_SERVICE_CATEGORY_LIST, serviceCategoryList);
		}
